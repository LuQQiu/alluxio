...
import alluxio.cli.fsadmin.embeddedfuse.MountCommand;
import alluxio.cli.fsadmin.embeddedfuse.UnmountCommand;
 ...
 */
@PublicApi
public final class EmbeddedFuseCommand extends AbstractFsAdminCommand {

  private static final Map<String, BiFunction<Context, AlluxioConfiguration, ? extends Command>>
      SUB_COMMANDS = new HashMap<>();

  static {
    SUB_COMMANDS.put("mount", MountCommand::new);
    SUB_COMMANDS.put("unmount", UnmountCommand::new);
  }
   ...
   */
  public EmbeddedFuseCommand(Context context, AlluxioConfiguration alluxioConf) {
    super(context);
