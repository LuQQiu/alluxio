...
public final class SharedGrpcDataReaderTest {
  ...
  private static final long BLOCK_SIZE = 5 * CHUNK_SIZE;

  private FileSystemContext mContext;
  private WorkerNetAddress mAddress;
  private BlockWorkerClient mClient;
  private SharedGrpcDataReader.Factory mFactory;
  ...
  public void before() throws Exception {
    ...
    mFactory = new SharedGrpcDataReader.Factory(mContext, mAddress, readRequest, BLOCK_SIZE);
