...
public interface Allocator {
   ...
   *         otherwise
   */
  StorageDir allocateBlockWithInfo(long sessionId, long blockSize, BlockStoreLocation location,
      List<StorageTier> tierList, Map<String, StorageTier> aliasToTierMap);
}
