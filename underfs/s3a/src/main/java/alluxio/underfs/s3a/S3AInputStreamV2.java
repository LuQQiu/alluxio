 ...
 */
@NotThreadSafe
public class S3AInputStreamV2 extends InputStream {
   ...
   */
  public S3AInputStreamV2(String bucketName, String key, AmazonS3 client, RetryPolicy retryPolicy) {
   ...
   * @param retryPolicy retry policy in case the key does not exist
   */
  public S3AInputStreamV2(String bucketName, String key, AmazonS3 client,
